...
public class Gun {
	...
	private String[] four = { "Shrapnel-10 Buckshot", "Barrikada Slug", // Normal 23x75mm indexes 0-1
	...
	public Gun(String weapon) {
		...
		if (weapon.equals("PM") || weapon.equals("PP-91")) { // 9x18mm
			...
			this.NineThirtyNine();
		} else if (weapon.equals("UMP")) { // .45 ACP
			this.FortyFive();
			...
			this.TwentyGauge();
		} else if (weapon.equals("KS-23M")) { // 4 Gauge
			this.FourGauge();
		} else if (weapon.equals("VPO-215")) { // .366 TKM
			this.ThreeSixSix();
	...
	private void FortyFive() { // Method encompassing .45 ACP caliber weapons
		Ammo temp = new Ammo();
		int random = (int) Math.random() * 3;
	...
	private void TwentyGauge() { // Method encompassing 20 gauge caliber weapons
		Ammo temp = new Ammo();
	...
	private void FourGauge() { // Method encompassing 4 gauge caliber weapons
		Ammo temp = new Ammo();
		int random = (int) Math.random() * 3;
		this.setAmmunition(temp.fourG(four[random]));
	...
	private void ThreeSixSix() { // Method encompassing .366 TKM caliber weapons
		Ammo temp = new Ammo();
		int random = (int) Math.random() * 3;
	...
	private void FiveFiveSix() { // Method encompassing 5.56x39mm caliber weapons
		Ammo temp = new Ammo();
		int random = (int) Math.random() * 7;
	...
	private void SevenFiftyOne() { // Method encompassing 7.62x51mm caliber weapons
		Ammo temp = new Ammo();
		int random = (int) Math.random() * 4;
	...
	private void SevenFiftyFour() { // Method encompassing 7.62x54mmR caliber weapons
		Ammo temp = new Ammo();
		int random = (int) Math.random() * 4;
	...
	private void ThreeHundred() { // Method encompassing .300 Blackout caliber weapons
		Ammo temp = new Ammo();
		int random = (int) Math.random() * 4;
		this.setAmmunition(temp.threeHundred(threeHundred[random]));
	...
	private void SixEight() {  // Method encompassing 6.8x51mm caliber weapons
		Ammo temp = new Ammo();
		int random = (int) Math.random() * 2;
		this.setAmmunition(temp.sixEight(sixEight[random]));
	...
	private void TwelveSeven() { // Method encompassing 12.7x55mm caliber weapons
		Ammo temp = new Ammo();
		int random = (int) Math.random() * 3;
		this.setAmmunition(temp.twelveSeven(twelveSeven[random]));
	...
	private void ThreeThreeEight() { // Method encompassing .338 Lapua Magnum caliber weapons
		Ammo temp = new Ammo();
		int random = (int) Math.random() * 3;
		this.setAmmunition(temp.threeThreeEight(threeThreeEight[random]));
